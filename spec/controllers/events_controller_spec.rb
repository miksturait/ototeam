  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved event as @event" do
        ...
        post :create, {:event => { "state" => "invalid value" }}, valid_session
        expect(assigns(:event)).to be_a_new(Event)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested event" do
        ...
        expect_any_instance_of(Event).to receive(:update).with({ "state" => "MyString" })
        put :update, {:id => event.to_param, :event => { "state" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the event as @event" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        allow_any_instance_of(Event).to receive(:save).and_return(false)
        put :update, {:id => event.to_param, :event => { "state" => "invalid value" }}, valid_session
        expect(assigns(:event)).to eq(event)
      end
